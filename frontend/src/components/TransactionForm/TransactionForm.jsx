                ...
                <form onSubmit={handleSubmitUpdatePurchase}>
                  <div className="mt-2">
                    ...
                    <div className="flex justify-center mt-6 flex-col sm:flex-row">
                      <button onClick={() => switchSellOrBuy(false)} type="submit" className="w-full px-4 py-2 text-white transition-colors duration-200 transform bg-yellow-500 rounded-md dark:bg-yellow-700 hover:bg-yellow-600 dark:hover:bg-yellow-600 focus:outline-none focus:bg-yellow-500 dark:focus:bg-yellow-600">{ shares < 0 ? "Sell" : "Buy More"} </button>

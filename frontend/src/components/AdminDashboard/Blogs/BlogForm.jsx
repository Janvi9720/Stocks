...
export default function Blog({ handleCloseModal, currentBlog }) {
  ...
  const [fileName, setFileName] = useState(Object.keys(currentBlog).length !== 0 ? currentBlog.image : "");
  const [value, setValue] = useState(Object.keys(currentBlog).length !== 0 ? currentBlog.content : "");
  ...
  const handleImageChange = (e) => {
    ...
    setForm({ ...form, [e.target.name]: Object.keys(currentBlog).length !== 0 ? newFile : e.target.files[0] });
  }
          ...
          <div className="grid grid-cols-1 gap-6 mt-4  ">
            <div>
              ...
              <input
                ...
                defaultValue={Object.keys(currentBlog).length !== 0 ? currentBlog.title : ""}
            ...
            <div>
              ...
              <input
                ...
                name="tag"
                onChange={handleChange}
                defaultValue={Object.keys(currentBlog).length !== 0 ? currentBlog.tag : ""}
            ...
            <div>
              ...
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div className="space-y-1 text-center">
                  {Object.keys(currentBlog).length !== 0 && currentBlog.image ? (
                    <>
                      <img
